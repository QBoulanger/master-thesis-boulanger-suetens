...
def greedy_function(list_of_states, state, a, b):
    min_distance = 0
...
def run_taxi(learning_rate, discount_factor, num_episodes, train_visual, val_visual, a, b):
    """
    ...
    for episode in range(num_episodes):
        ...
        while not done and not truncated:
            ...
            reward += greedy_function(list_of_states, next_state, a, b)
    ...
    for episode in range(num_episodes):
        ...
        while not done and not truncated:
            ...
            if episode % num_episodes == 0 and train_visual:
                show_visual(env)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--discount_factor', type=float, help='Discount factor', default=0.50)
    parser.add_argument('--num_of_episods', type=int, help='Num of Episods', default=2000)
    parser.add_argument('--num_of_runs', type=int, help='Num of Runs (the average is taken from them)', default=2)
    parser.add_argument('--remember_deep', type=int, help='Num of Runs (the average is taken from them)', default=1)
    parser.add_argument('--reward_division', type=int, help='Num of Runs (the average is taken from them)', default=20)
    ...
    for j in range(args.num_of_runs):
        total_res += run_taxi(learning_rate, discount_factor, num_of_episods, False, False, remember_deep,
                              reward_division)
